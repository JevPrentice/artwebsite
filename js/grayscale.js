...
function collapseNavbar() {
    var url_end = window.location.pathname.split("/").slice(-1)[0]

    if (url_end=="about_me.html" || url_end=="contact.html" || url_end=="self-portraits.html"){
        $(".navbar-fixed-top").show();
    } 
    else if ($(".navbar").offset().top > 500) {
        $(".navbar").fadeIn(3000);
